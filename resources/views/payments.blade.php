...
<div id="Rectangle17" onclick="gotom('payments2')" ></div>
<img id="image6" onclick="gotom('payments2')"  src="{{ asset('/images/image%206.png') }}">
...
<div id="ConfirmPayment">Confirm Payment</div>
